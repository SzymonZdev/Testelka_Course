...
public class CheckoutTests extends BaseTests {
    ...
    public void successful_purchase_should_show_order_received_message() {
        ...
        driver.findElement(By.cssSelector("#billing_phone")).sendKeys("66666666");
        ...
        driver.findElement(By.cssSelector("[name='cardnumber']")).sendKeys("4242 4242 4242 4242");
        driver.switchTo().defaultContent();

        wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.cssSelector("#stripe-exp-element iframe")));
        driver.findElement(By.cssSelector("[name='exp-date']")).sendKeys("04/44");
        driver.switchTo().defaultContent();
